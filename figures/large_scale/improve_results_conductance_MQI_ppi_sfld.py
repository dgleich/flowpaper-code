...
mygraphs = {#'email-Enron':'/u4/kfountoulakis/flowReviewPaper/LocalGraphClustering/notebooks/datasets/email-Enron.edgelist',
            ...
            'ppi':'/u4/kfountoulakis/flowReviewPaper/LocalGraphClustering/notebooks/datasets/ppi_mips.graphml',
            'sfld':'/u4/kfountoulakis/flowReviewPaper/LocalGraphClustering/notebooks/datasets/sfld_brown_et_al_amidohydrolases_protein_similarities_for_beh.graphml'
           }
