...
\draw [rotate around={-70:(9.75,3.4)},line width=0.0pt,color=bordercolor,fill=bordercolor] (9.75,3.4) ellipse (0.47in and 0.2in);
​
...
\node [color=darkgrey,text=lightgrey] (aR2) at (12,3.5) {a2};
...
% \draw[-] (R6) to (R4);
% \draw[-] (R6) to (R5);
\draw[-,color=darkgrey] (aR1) to (aR2);
\draw[-] (aR1) to (aR3);
\draw[-,color=darkgrey] (aR2) to (aR3);
...
\draw[-,color=darkgrey] (aR2) to [bend left=0] (t);
...
\node[line width=0,font=\fontsize{8}{8}\selectfont] at (8.7,3.35) {$\partial R$};
