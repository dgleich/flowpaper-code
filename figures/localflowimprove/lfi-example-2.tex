...
​
\draw[color=white,rounded corners=10pt,line width=0pt,fill=Rcolor] (8.8,-0.15) rectangle ++(4.5,4.8);
​
...
\node (U1) at (10.3,1.6) {U1};
\node (U2) at (12.1,0.3) {U2};
\node (U3) at (10.5,0.4) {U3};
...
​
\begin{scope}[line width=1pt]
\draw[-] (U1) to [bend right=15] (t);
\draw[-] (U2) to [bend right=15] (t);
\draw[-] (U3) to [bend right=10] (t);
