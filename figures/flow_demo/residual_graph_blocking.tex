...
\draw[postaction={decorate}] (d) to [bend left=17] (t);
\draw[postaction={decorate}] (c) to [bend right=15] (d);
\draw[postaction={decorate}] (d) to [bend right=15] (c);
\draw[postaction={decorate}] (b) to [bend right=10] (c);
\draw[postaction={decorate}] (c) to [bend right=10] (b);
\draw[postaction={decorate}] (a) to [bend right=17] (s);
\draw[postaction={decorate}] (s) to [bend right=17] (a);
