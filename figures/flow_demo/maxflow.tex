...
\draw [gray,transform canvas={xshift=-0.3em,yshift=0.3em},dash pattern=on 4pt off 2pt,postaction={decorate,decoration={markings,mark=between positions 4pt and 1 step 6pt with {\pgftransformscale{1.25}\arrow{>};}}}] (s) to (sa);

\draw [gray,transform canvas={xshift=-0.3em,yshift=0.3em},dash pattern=on 4pt off 2pt,postaction={decorate,decoration={markings,mark=between positions 4pt and 1 step 6pt with {\pgftransformscale{1.25}\arrow{>};}}}] (sa) to (a);
...
\draw [gray,transform canvas={yshift=-0.5em},dash pattern=on 4pt off 2pt,postaction={decorate,decoration={markings,mark=between positions 4pt and 1 step 6pt with {\pgftransformscale{1.25}\arrow{>};}}}] (b) to (bd);

\draw [gray,transform canvas={yshift=-0.5em},dash pattern=on 4pt off 2pt,postaction={decorate,decoration={markings,mark=between positions 4pt and 1 step 6pt with {\pgftransformscale{1.25}\arrow{>};}}}] (bd) to (d);

\draw [gray,transform canvas={xshift=0.5em},dash pattern=on 4pt off 2pt,postaction={decorate,decoration={markings,mark=between positions 4pt and 1 step 6pt with {\pgftransformscale{1.25}\arrow{>};}}}] (d) to (dc);

\draw [gray,transform canvas={xshift=0.5em},dash pattern=on 4pt off 2pt,postaction={decorate,decoration={markings,mark=between positions 4pt and 1 step 6pt with {\pgftransformscale{1.25}\arrow{>};}}}] (dc) to (c);

\draw [gray,transform canvas={xshift=0.3em,yshift=-0.3em},dash pattern=on 4pt off 2pt,postaction={decorate,decoration={markings,mark=between positions 4pt and 1 step 6pt with {\pgftransformscale{1.25}\arrow{>};}}}] (d) to (dt);

\draw [gray,transform canvas={xshift=0.3em,yshift=-0.3em},dash pattern=on 4pt off 2pt,postaction={decorate,decoration={markings,mark=between positions 4pt and 1 step 6pt with {\pgftransformscale{1.25}\arrow{>};}}}] (dt) to (t);

\draw [gray,transform canvas={xshift=0.3em,yshift=-0.4em},dash pattern=on 4pt off 2pt,postaction={decorate,decoration={markings,mark=between positions 4pt and 1 step 6pt with {\pgftransformscale{1.25}\arrow{>};}}}] (b) to (cb);

\draw [gray,transform canvas={xshift=0.3em,yshift=-0.4em},dash pattern=on 4pt off 2pt,postaction={decorate,decoration={markings,mark=between positions 4pt and 1 step 6pt with {\pgftransformscale{1.25}\arrow{>};}}}] (cb) to (c);
