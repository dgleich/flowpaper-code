...
sizes = 3.0*ones(length(x))
sizes[subsetnodes_c] .= 8.0
# using JLD
# save("hexbin_plot_spectral.jld","xsh",xsh,"ysh",ysh,"vh",vh,"x",x,"y",y,"colors",colors,"subsetnodes_c",subsetnodes_c)
...
png("hexbin_plot_spectral_high_res.png")
...
png("hexbin_plot_spectral_low_res.png")
